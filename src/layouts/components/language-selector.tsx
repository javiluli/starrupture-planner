...
export const LanguageSelector = () => {
  ...
  const setLanguageStore = useDataStore(dataSelectors.setLanguage)

  // Inicializamos el estado con el idioma actual de i18n (que deberia ser 'en')
  ...
  return (
    <Dropdown className="min-w-28">
      ...
      >
        ...
        <DropdownItem key="es" textValue="Espanol">
          Español
        </DropdownItem>
      </DropdownMenu>
    </Dropdown>
