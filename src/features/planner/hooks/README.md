...
- `use-production-plan.ts`: construye el plan unico a partir del store (variantes por item).
...
2. `use-production-plan` lee target, supply y variantes del store y crea el `plan`.
