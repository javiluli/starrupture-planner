...
export const useProductionPlan = () => {
  ...
  const isExportable = useMemo(
    () => isItemExportableToCorporation(corporations, targetId),
    [corporations, targetId],
  )
  ...
  }, [buildings, targetId, targetIpm, supplyCountByItem, buildingVariantByItemId, isExportable])
