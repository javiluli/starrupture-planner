...
Apply these rules directly and proportionally to the repository. Prefer its existing type conventions and validation libraries; do not require another skill as a prerequisite.
