...
2. If a page can run, use the installed [web performance skill](../web-perf/SKILL.md) to collect a minimal live baseline before searching the codebase broadly.
...
For detailed guidance that is installed with this skill:

- [Web performance](../web-perf/SKILL.md)
- [Web interface guidelines](../web-design-guidelines/SKILL.md)
